...
export default function Header() {
  return (
    <header className="fixed top-0 left-1/2 z-50 flex w-full max-w-120 -translate-x-1/2 flex-col border-b-[0.5px] border-[#F3F4F6]/50 bg-white/90 pt-[env(safe-area-inset-top)] backdrop-blur-xl">
